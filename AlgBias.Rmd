...
generate_arrests <- function(arrest_rate, num_crimes){
  return(rbinom(1, num_crimes, arrest_rate))
}

generate_arrest_probability <- function(num_police, population, race, crime)
{
  encounter_multiplier <- num_police / population
  if(crime == "Major"){
    return(0.9)
  }
  else{
...
generate_arrest_probability(1000, 1000000, "Black", "Nuisance")

# Old Gotham Major Arrests
og_black_major_arrests <- generate_arrests(generate_arrest_probability(og_cops, og_black_pop, "Black", "Major"),
                                  og_black_major)
og_latino_major_arrests <- generate_arrests(generate_arrest_probability(og_cops, og_latino_pop, "Latino", "Major"),
                                  og_latino_major)
og_white_major_arrests <- generate_arrests(generate_arrest_probability(og_cops, og_white_pop, "White", "Major"),
                                  og_white_major)
# 
# New Gotham Major Arrests
ng_black_major_arrests <- generate_arrests(generate_arrest_probability(ng_cops, ng_black_pop, "Black", "Major"),
                                  ng_black_major)
ng_latino_major_arrests <- generate_arrests(generate_arrest_probability(ng_cops, ng_latino_pop, "Latino", "Major"),
                                  ng_latino_major)
ng_white_major_arrests <- generate_arrests(generate_arrest_probability(ng_cops, ng_white_pop, "White", "Major"),
                                  ng_white_major)
# 
# # Old Gotham Nuisance
og_black_nuisance_arrests <- generate_arrests(generate_arrest_probability(og_cops, og_black_pop, "Black", "Nuisance"),
                                  og_black_nuisance)
og_latino_nuisance_arrests <- generate_arrests(generate_arrest_probability(og_cops, og_latino_pop, "Latino", "Nuisance"),
                                  og_latino_nuisance)
og_white_nuisance_arrests <- generate_arrests(generate_arrest_probability(og_cops, og_white_pop, "White", "Nuisance"),
                                  og_white_nuisance)
# 
# # New Gotham Nuisance
ng_black_nuisance_arrests <- generate_arrests(generate_arrest_probability(ng_cops, ng_black_pop, "Black", "Nuisance"),
                                  ng_black_nuisance)
ng_latino_nuisance_arrests <- generate_arrests(generate_arrest_probability(ng_cops, ng_latino_pop, "Latino", "Nuisance"),
                                  ng_latino_nuisance)
ng_white_nuisance_arrests <- generate_arrests(generate_arrest_probability(ng_cops, ng_white_pop, "White", "Nuisance"),
                                  ng_white_nuisance)

arrests <- tibble(type = c(
  rep("Major", og_black_major_arrests + og_latino_major_arrests + og_white_major_arrests),
  rep("Nuisance", og_black_nuisance_arrests + og_latino_nuisance_arrests + og_white_nuisance_arrests),
  rep("Major", ng_black_major_arrests + ng_latino_major_arrests + ng_white_major_arrests),
  rep("Nuisance", ng_black_nuisance_arrests + ng_latino_nuisance_arrests + ng_white_nuisance_arrests)
) , 
race = c(
  rep("Black", og_black_major_arrests),
  rep("Latino", og_latino_major_arrests),
  rep("White", og_white_major_arrests),
  rep("Black", og_black_nuisance_arrests),
  rep("Latino", og_latino_nuisance_arrests),
  rep("White", og_white_nuisance_arrests),
  rep("Black", ng_black_major_arrests),
  rep("Latino", ng_latino_major_arrests),
  rep("White", ng_white_major_arrests),
  rep("Black", ng_black_nuisance_arrests),
  rep("Latino", ng_latino_nuisance_arrests),
  rep("White", ng_white_nuisance_arrests)
), 
borough = c(
  rep("Old Gotham", og_black_major_arrests + og_latino_major_arrests + og_white_major_arrests + og_black_nuisance_arrests + og_latino_nuisance_arrests + og_white_nuisance_arrests),
  rep("New Gotham", ng_black_major_arrests + ng_latino_major_arrests + ng_white_major_arrests + ng_black_nuisance_arrests + ng_latino_nuisance_arrests + ng_white_nuisance_arrests)
))
```
...
simple_model <- glm(borough_num ~ NULL, data = arrests)

old_prop <- predict(simple_model, newdata = tibble(type = "Major"))
old_prop
```

So 24.2% of crime occurs in Old Gotham. Let's allocate 24.2% of police to that neighborhood.

```{r}
og_cops <- round(total_police * old_prop)
ng_cops <- total_police - og_cops
