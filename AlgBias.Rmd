...
generate_arrest_probability <- function(num_police, num_crimes, bor_size, race, crime)
{
  encounter_multiplier <- 100 * num_police * num_crimes / bor_size^2
  if(crime == "Major"){
    arrest_val <- major_crime_multiplier*encounter_multiplier
  }
  else{
    if(race == "Black"){
